<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="GoodEvaluateList.aspx.cs" Inherits="XFXManagement.GoodEvaluateList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" GridLines="None" CssClass="GridView"
        AutoGenerateColumns="False" DataKeyNames="GoodEvaluateID"
        AllowSorting="True" OnSorting="GridView1_Sorting" OnRowCommand="GridView1_RowCommand">
        <Columns>

            <asp:BoundField DataField="GoodGategoryID" HeaderText="商品分类" SortExpression="GoodGategoryID" />
            ...
            <asp:BoundField DataField="Detail" HeaderText="评论" SortExpression="Detail" />

            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="StateDeleteID" CommandName="StateDelete" runat="server" CommandArgument='<%# Eval("GoodEvaluateID") %>'
                        
                         OnClientClick="if( confirm('确定要删除此评论吗？')){return true; }else{return false;}">删除</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <EmptyDataTemplate>
